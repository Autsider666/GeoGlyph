...
export class OldViewpointComponent extends BaseComponent implements ViewPoint {
    ...
    drawViewPoint(ctx: CanvasRenderingContext2D): void {
        ...
        for (const {
            getAngle = (): number => OldViewpointComponent.defaultAngle,
            getRange = (): number => OldViewpointComponent.defaultRange,
            getFalloff = (): number => OldViewpointComponent.defaultFalloff,
        } of this.viewPoints) {
